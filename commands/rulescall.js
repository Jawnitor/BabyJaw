...
module.exports = {
    ...
    execute(message, args){
        message.channel.send("**Welcome to the (unofficial)College Discord Server**\nPlease go to #¬roles and select if you are a <@&736160061285728338> or <@&736159983087124552> (tutor role requires verification) and all read the rules.\nOnce you have selected your role you will have access to the server.(you can also select your course specific role to access chats for your course)\n \n"
